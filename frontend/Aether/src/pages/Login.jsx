        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div className="aether-mono" style={{
              ...
              fontSize: 10, color: 'rgba(57,255,136,0.8)', letterSpacing: '1px',
              animation: 'fadeUp 0.6s 0.35s both',
            }}>
              <div style={{
                width: 6, height: 6, borderRadius: '50%', background: '#39FF88',
                boxShadow: '0 0 6px #39FF88', animation: 'blink 2s ease-in-out infinite',
              }} />
